...
-   Только авторизованные пользователи имеют доступ к системе планирования заданий.
-   Система планирования заданий -- блок, повышающей целостность.

## Цели безопасности

-   При любых обстоятельствах АНТС выполняет только аутентичные маршрутные задания.

## Политика архитектуры

![Политика архитектуры](images/architecture_policy.png)
